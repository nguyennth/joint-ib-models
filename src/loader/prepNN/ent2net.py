...
def entity2network(sentence_data, words, params, tokenizer_encoder):
    ...
    return readable_e, idxs, ents, toks2, etypes2ids, entities, \
        sw_sentence, sub_to_word, subwords, valid_starts, tagsIDs, tagsTR, terms
