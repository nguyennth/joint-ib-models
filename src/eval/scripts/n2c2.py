...
class MultipleEvaluator(object):
    ...
    def track2(self, corpora, tag_type=None, mode='strict', verbose=False):
        ...
        # -----------------------------------------ACE--------------------------------------------
        elif corpora.corpus_type == 'ace2005':
            self.tags = (
                'FAC', 'LOC', 'ORG', 'PER', 'WEA', 'GPE', 'VEH'
        ...
        # -----------------------------------------BC5CDR--------------------------------------------
        elif corpora.corpus_type == 'bc5cdr-chemical':
            self.tags = (
                "Chemical",
            )
            self.exclude_tags = (
        ...
        # -----------------------------------------NCBI--------------------------------------------
        elif corpora.corpus_type == 'ncbi' or corpora.corpus_type == 'bc5cdr-disease':
            self.tags = (
                "Disease",
            )
            self.exclude_tags = (
        ...
        # -----------------------------------------n2c2-2022-one category--------------------------------------------
        elif corpora.corpus_type == 'n2c2':
            self.tags = (
                "MedicalMention",
            )
            self.exclude_tags = (
        ...
        # -----------------------------------------MedMention-21--------------------------------------------
        elif corpora.corpus_type == 'medmention-21':
            self.tags = (
                "T005",
                "T007",
                "T017",
        ...
        # -----------------------------------------GE04--------------------------------------------
        elif corpora.corpus_type == 'genia':
            self.tags = (
                "protein",
                "DNA",
                "cell_type",
        ...
        # -----------------------------------------BC5CDR--------------------------------------------
        elif corpora.corpus_type == 'bc5cdr':
            self.tags = (
                "Chemical",
                "Disease",
            )
        ...
        # -----------------------------------------CHEMPROT--------------------------------------------
        elif corpora.corpus_type == 'chemprot':
            self.tags = (
                "CHEMICAL",
                "GENE-N",
                "GENE-Y",
